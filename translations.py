translations = {
    "EN": {
        ...
        "money_at_retirement_title": "Money at Retirement (Age {retirement_age})",
        "range_of_outcomes_retirement": "Range of Outcomes at Retirement (Age {retirement_age})",
        "info_bar_chart_retirement": "This chart shows the range of portfolio values when you retire at age {retirement_age}. This is your starting point for the retirement drawdown phase.",
        "ruin_warning": "Warning: There is a {lifetime_prob:.1f}% chance of running out of money before you die, and a {age_prob:.1f}% chance if you live to age {end_age}.",
        ...
        "info_mortality_curve": "This curve shows the statistical probability of a person of your age & region living to each subsequent age. Life expectancy of {life_expectancy:.1f} is the average age at death for someone who has already reached retirement age.",
        ...
        "info_ruin_risk_curve": "This curve shows the probability of running out of money **before you die**, looking forward from each age. At retirement, your total lifetime ruin risk is {retirement_risk:.1f}%. As you age, the risk typically increases because your portfolio is depleting while you still need to fund remaining years.",
    ...
    "PT": {
        ...
        "money_at_retirement_title": "Dinheiro na Aposentadoria (Idade {retirement_age})",
        "range_of_outcomes_retirement": "Gama de Resultados na Aposentadoria (Idade {retirement_age})",
        "info_bar_chart_retirement": "Este gráfico mostra a gama de valores do portfólio quando você se aposentar aos {retirement_age} anos. Este é o seu ponto de partida para a fase de retiradas.",
        "ruin_warning": "Aviso: Há uma chance de {lifetime_prob:.1f}% de ficar sem dinheiro antes de morrer, e {age_prob:.1f}% de chance se você viver até os {end_age} anos.",
        ...
        "info_mortality_curve": "Esta curva mostra a probabilidade estatística de uma pessoa da sua idade e região viver até cada idade futura. A expectativa de vida de {life_expectancy:.1f} anos é a idade média de morte para alguém que já atingiu a idade de aposentadoria.",
        ...
        "info_ruin_risk_curve": "Esta curva mostra a probabilidade de ficar sem dinheiro **antes de morrer**, olhando para frente a partir de cada idade. Na aposentadoria, seu risco total de ruína vitalício é de {retirement_risk:.1f}%. Conforme você envelhece, o risco tipicamente aumenta porque seu portfólio está diminuindo enquanto você ainda precisa financiar os anos restantes.",
